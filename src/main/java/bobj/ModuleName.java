...
public class ModuleName
    ...
    public ModuleName instance(ModuleName[] mods) {
        ...
        for (ModuleName mod : mods) {
            result.subexps.add(mod);
        }
        return result;
    }
                ...
                case GENERAL_INSTANCE:
                    ...
                    if (name.subexps.size() == this.subexps.size()) {
                        for (int i = 0; i < subexps.size(); i++ ) {
                            ...
                            if (obj1 instanceof View && obj2 instanceof View) {
                            ...
                            } else if (obj1 instanceof ModuleName && obj2 instanceof ModuleName) {
                            ...
                            } else if (obj1 instanceof ModuleName && obj2 instanceof View) {
                            ...
                            } else if (obj2 instanceof ModuleName && obj1 instanceof View) {
                            ...
                            /* if (!name.subexps.get(i).equals(subexps.get(i))) { return false; } */
                        }
                        return true;
                    } else {
                        return false;
    ...
    public ModuleName changeModuleName(ModuleName from,
                                       ModuleName to) {
                ...
                for (int i = 1; i < subexps.size(); i++ ) {
                    ...
                    if (obj instanceof ModuleName) {
                        ...
                        if (view.target.modName.toString()
                            ...
                            if (to.view != null && to.view.source.modName.equals(tmp)) {
    ...
    public ModuleName changeParameterName(String from,
                                          String to) {
            ...
            case GENERAL_INSTANCE:
                ...
                for (int i = 1; i < subexps.size(); i++ ) {
                    ...
                    if (obj instanceof ModuleName) {
                        ...
                        /* View view = (View)obj; if
                         * (view.name.equals(view.target.modName.toString())) { view = view.copy(
                         * view.target.modName.changeParameterName(from, to).toString());
                         * list.add(view); } else { list.add(obj); } */
                        // end modification
