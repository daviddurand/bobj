...
public class RewriteEngine {
    ...
    public boolean turnoff2Eq = false;

    public boolean turnoff3Eq = false;

    static boolean debug = false;

    HashMap<String, Term> cache = new HashMap<>();

    Vector<String> hit = new Vector<>();
...
//                */
     ...
     *
     */
    public Vector<Map<VarOrCode, Term>> getAllMatches(Term input,
                                                      Term pattern) {
...
// TODO Check if early exit would be OK
    ...
    public Redex getSpecialRedex(Term input,
                                 int pos) {
