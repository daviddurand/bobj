...
public class ModuleFactory {
    ...
    public static Module createTruth() {
        ...
        try {
            ...
            Sort bool = result.sorts.elementAt(0);
            Operation trueOp = result.operations.elementAt(0);
            Operation falseOp = result.operations.elementAt(1);
            ...
            Operation eqOp = new Operation("_ == _", new Sort[]
                {
                    universal, universal
                }, bool, modName);
            ...
            Equation eq1 = new Equation(new Term(eqOp, new Term(x), new Term(x)), new Term(trueOp));
            ...
            // define operation _=/=_
            Operation neqOp = new Operation("_ =/= _", new Sort[]
                {
                    universal, universal
                }, bool, modName);
            ...
            Operation ifOp = new Operation("if_then_else_fi", new Sort[]
                {
                    bool, universal, universal
                }, universal, modName);
            ...
            Equation eq2 = new Equation(new Term(ifOp, new Term(trueOp), new Term(x), new Term(y)),
                                        new Term(x));
            ...
            Equation eq3 = new Equation(new Term(ifOp, new Term(falseOp), new Term(x), new Term(y)),
                                        new Term(y));
            ...
            Equation eq4 =
                new Equation(new Term(ifOp, new Term(b), new Term(x), new Term(x)), new Term(x));
    ...
    public static Module createBool() {
        ...
        try {
            ...
            // add operation and
            Operation and = new Operation("_ and _", new Sort[]
                {
                    bool, bool
                }, bool, modName);
            and.setPriority(20);
            ...
            // add operation or
            Operation or = new Operation("_ or _", new Sort[]
                {
                    bool, bool
                }, bool, modName);
            or.setPriority(30);
            ...
            // add operation xor
            Operation xor = new Operation("_ xor _", new Sort[]
                {
                    bool, bool
                }, bool, modName);
            ...
            Operation implies = new Operation("_ implies _", new Sort[]
                {
                    bool, bool
                }, bool, modName);
            ...
            // add operation not
            Operation not = new Operation("not _", new Sort[]
                {
                    bool
                }, bool, modName);
            not.setPriority(10);
            ...
            Equation eq = new Equation(new Term(not, trueTerm), falseTerm);
            eq.setInfo("system-default");
            result.equations.add(eq);

            // eqaution: not false = true
            eq = new Equation(new Term(not, falseTerm), trueTerm);
            eq.setInfo("system-default");
            result.equations.add(eq);

            // equation: true and B = B .
            eq = new Equation(new Term(and, trueTerm, b), b);
            eq.setInfo("system-default");
            result.equations.add(eq);

            // equation: false and B = false .
            eq = new Equation(new Term(and, falseTerm, b), falseTerm);
            eq.setInfo("system-default");
            result.equations.add(eq);

            // equation: true or B = true
            eq = new Equation(new Term(or, trueTerm, b), trueTerm);
            eq.setInfo("system-default");
            result.equations.add(eq);

            // equation: false or B = B
            eq = new Equation(new Term(or, falseTerm, b), b);
            eq.setInfo("system-default");
            result.equations.add(eq);

            // equation: B1 implies B2 = (not B1) or B2
            Term left = new Term(implies, b1, b2);
            Term right = new Term(or, new Term(not, b1), b2);
    ...
    public static Module createQid() {
        ...
        try {
            ...
            java.util.List<Sort> list = new java.util.ArrayList<>();
            list.add(id);
    ...
    public static Module createNzNat() {
        ...
        try {
            ...
            Operation succ = new Operation("s _", new Sort[]
                {
                    nznat
                }, nznat, modName);
    ...
    public static Module createNat() {
        ...
        try {
            ...
            Sort bool = result.sorts.elementAt(0);
            Sort nznat = result.sorts.elementAt(4);
            result.addSubsort(nat, nznat);
            result.addSubsort(nat, z);

            Operation t = result.operations.elementAt(0);
            Operation f = result.operations.elementAt(1);
            Operation or = result.operations.elementAt(6);
            Operation and = result.operations.elementAt(5);
            Operation not = result.operations.elementAt(9);
            ...
            Operation pred = new Operation("p _", new Sort[]
                {
                    nznat
                }, nat, modName);
            ...
            // equation 0 > N = false
            Term r1 = new Term(f);
            Term l1 = new Term(result, less, new Term(result, zero), new Term(n));
            eq = new Equation(l1, r1);
            eq.setInfo("system-default");
            result.equations.add(eq);

            // equation s N > 0 = true
            Term l2 = new Term(result, less, new Term(succ, new Term(n)), new Term(zero));
            Term r2 = new Term(t);
            ...
            Term l3 =
                new Term(result, less, new Term(succ, new Term(n)), new Term(succ, new Term(m)));
            Term r3 = new Term(result, less, new Term(n), new Term(m));
            ...
            Term l4 = new Term(result, equal, new Term(n), new Term(n));
            Term r4 = new Term(t);
            ...
            Term l5 = new Term(result, equal, new Term(zero), new Term(succ, new Term(n)));
            Term r5 = new Term(f);
            ...
            Term l6 = new Term(result, equal, new Term(succ, new Term(n)), new Term(zero));
            Term r6 = new Term(f);
            ...
            Term l7 =
                new Term(result, equal, new Term(succ, new Term(n)), new Term(succ, new Term(m)));
            Term r7 = new Term(result, equal, new Term(n), new Term(m));
            eq = new Equation(l7, r7);
            eq.setInfo("system-default");
            result.equations.add(eq);

            // equation eq(N, M) = false if N < M or M < N
            Term l9 = new Term(equal, new Term(n), new Term(m));
            Term r9 = new Term(f);
            Term c9 = new Term(or, new Term(greater, new Term(n), new Term(m)),
                               new Term(greater, new Term(m), new Term(n)));
            ...
            // equation M < 0 = false
            Term r10 = new Term(f);
            Term l10 = new Term(result, greater, new Term(m), new Term(result, zero));
            ...
            // equation 0 < s N = true
            Term r11 = new Term(t);
            Term l11 = new Term(result, greater, new Term(zero), new Term(succ, new Term(n)));
            ...
            // equation s N < s M = N > M
            Term l12 =
                new Term(result, greater, new Term(succ, new Term(n)), new Term(succ, new Term(m)));
            Term r12 = new Term(result, greater, new Term(n), new Term(m));
            eq = new Equation(l12, r12);
            eq.setInfo("system-default");
            result.equations.add(eq);

            // eq geq(N, s M) = N > M .
            Term l13 = new Term(result, geq, new Term(succ, new Term(m)), new Term(n));
            Term r13 = new Term(greater, new Term(m), new Term(n));
            ...
            Term l8 = new Term(geq, new Term(n), new Term(m));
            Term r8 = new Term(or, new Term(equal, new Term(n), new Term(m)),
                               new Term(greater, new Term(n), new Term(m)));
            eq = new Equation(l8, r8);
            eq.setInfo("system-default");
            result.equations.add(eq);

            // 0 > N = false
            Term l15 = new Term(result, less, new Term(zero), new Term(n));
            Term r15 = new Term(f);
            ...
            Term l16 =
                new Term(result, less, new Term(succ, new Term(n)), new Term(succ, new Term(m)));
            Term r16 = new Term(result, less, new Term(n), new Term(m));
            eq = new Equation(l16, r16);
            eq.setInfo("system-default");
            result.equations.add(eq);

            // s N > 0 = true
            Term l17 = new Term(result, less, new Term(succ, new Term(m)), new Term(zero));
            Term r17 = new Term(t);
            ...
            // N >= 0 = true
            Term l18 = new Term(result, leq, new Term(n), new Term(zero));
            Term r18 = new Term(t);
            ...
            // s N >= s M = N >= M
            Term l19 =
                new Term(result, leq, new Term(succ, new Term(n)), new Term(succ, new Term(m)));
            Term r19 = new Term(result, leq, new Term(n), new Term(m));
            eq = new Equation(l19, r19);
            eq.setInfo("system-default");
            result.equations.add(eq);

            // 0 >= s N = false
            Term l20 = new Term(result, leq, new Term(zero), new Term(succ, new Term(n)));
            Term r20 = new Term(f);
            ...
            // N >= N = true
            Term l21 = new Term(result, leq, new Term(n), new Term(n));
            Term r21 = new Term(t);
            ...
            // p s N = N
            Term r22 = new Term(n);
            Term l22 = new Term(result, pred, new Term(result, succ, new Term(n)));
    ...
    public static Module createInt() {
        ...
        try {
            ...
            Sort bool = result.sorts.elementAt(0);
            Sort nat = result.sorts.elementAt(4);
            Sort nznat = result.sorts.elementAt(6);

            result.addSubsort(inte, nat);
            result.addSubsort(nzint, nznat);
            result.addSubsort(inte, nzint);

            Operation zero = result.operations.elementAt(12);
            ...
            Operation divides = new Operation("_ divides _", a3, inte, modName);
            ...
            Term l1 = new Term(result, succ, new Term(result, pred, new Term(varI)));
            eq = new Equation(l1, r1);
            eq.setInfo("system-default");
            result.equations.add(eq);
            ...
            Term l2 = new Term(result, pred, new Term(result, succ, new Term(varI)));
            eq = new Equation(l2, r2);
            eq.setInfo("system-default");
            result.equations.add(eq);
            ...
            Term l3 = new Term(result, add, new Term(varI), new Term(result, zero));
            eq = new Equation(l3, r3);
            eq.setInfo("system-default");
            result.equations.add(eq);

            // I + s J = s(I + J)
            Term r4 = new Term(result, succ, new Term(result, add, new Term(varI), new Term(varJ)));
            Term l4 = new Term(result, add, new Term(varI), new Term(result, succ, new Term(varJ)));
            eq = new Equation(l4, r4);
            eq.setInfo("system-default");
            result.equations.add(eq);

            // I + p J = p(I + J)
            Term r5 = new Term(result, pred, new Term(result, add, new Term(varI), new Term(varJ)));
            Term l5 = new Term(result, add, new Term(varI), new Term(result, pred, new Term(varJ)));
            eq = new Equation(l5, r5);
            eq.setInfo("system-default");
            result.equations.add(eq);

            // I * 0 = 0
            Term r6 = new Term(result, zero);
            Term l6 = new Term(result, mult, new Term(varI), new Term(result, zero));
            eq = new Equation(l6, r6);
            eq.setInfo("system-default");
            result.equations.add(eq);

            // I * s J = I * J + I
            Term r7 = new Term(result, add, new Term(result, mult, new Term(varI), new Term(varJ)),
                               new Term(varI));
            Term l7 =
                new Term(result, mult, new Term(varI), new Term(result, succ, new Term(varJ)));
            eq = new Equation(l7, r7);
            eq.setInfo("system-default");
            result.equations.add(eq);

            // I * p J = I * J - I
            Term r8 = new Term(result, sub3, new Term(result, mult, new Term(varI), new Term(varJ)),
                               new Term(varI));
            Term l8 =
                new Term(result, mult, new Term(varI), new Term(result, pred, new Term(varJ)));
            eq = new Equation(l8, r8);
            eq.setInfo("system-default");
            result.equations.add(eq);

            // I * (J + K) = I * J + I * K
            Term l9 = new Term(result, mult, new Term(varI),
                               new Term(result, add, new Term(varJ), new Term(varK)));
            Term r9 = new Term(result, add, new Term(result, mult, new Term(varI), new Term(varJ)),
                               new Term(result, mult, new Term(varI), new Term(varK)));
            ...
            Term l10 = new Term(result, sub1, new Term(result, sub1, new Term(varI)));
            eq = new Equation(l10, r10);
            eq.setInfo("system-default");
            result.equations.add(eq);

            // - s I = p - I
            Term l11 = new Term(result, sub1, new Term(result, succ, new Term(varI)));
            Term r11 = new Term(result, pred, new Term(result, sub1, new Term(varI)));
            eq = new Equation(l11, r11);
            eq.setInfo("system-default");
            result.equations.add(eq);

            // - p I = s - I
            Term l12 = new Term(result, sub1, new Term(result, pred, new Term(varI)));
            Term r12 = new Term(result, succ, new Term(result, sub1, new Term(varI)));
            eq = new Equation(l12, r12);
            eq.setInfo("system-default");
            result.equations.add(eq);

            // I - J = I + - J
            Term l13 = new Term(result, sub3, new Term(varI), new Term(varJ));
            Term r13 =
                new Term(result, add, new Term(varI), new Term(result, sub1, new Term(varJ)));
            eq = new Equation(l13, r13);
            eq.setInfo("system-default");
            result.equations.add(eq);
            ...
            // I + - I = 0
            Term l14 =
                new Term(result, add, new Term(varI), new Term(result, sub1, new Term(varI)));
            Term r14 = new Term(result, zero);
            ...
            // -(I + J) = - I - J
            Term l15 =
                new Term(result, sub1, new Term(result, add, new Term(varI), new Term(varJ)));
            Term r15 =
                new Term(result, sub3, new Term(result, sub1, new Term(varI)), new Term(varJ));
            eq = new Equation(l15, r15);
            eq.setInfo("system-default");
            result.equations.add(eq);
            ...
            // I * - J = -(I * J) .
            Term l16 =
                new Term(result, mult, new Term(varI), new Term(result, sub1, new Term(varJ)));
            Term r16 =
                new Term(result, sub1, new Term(result, mult, new Term(varI), new Term(varJ)));
    ...
    public static Module createQidl() {
        ...
        try {
            ...
            Sort boolSort = result.sorts.elementAt(0);
            Sort idSort = result.sorts.elementAt(2);

            Operation less = new Operation("_<_", new Sort[]
                {
                    idSort, idSort
                }, boolSort, modName);
            less.setInfo("system-default");
    ...
    public static Module createIdentical() {
        ...
        try {
            ...
            Sort bool = result.sorts.elementAt(0);
            Sort universal = result.sorts.elementAt(1);
    ...
    public static Module createTuple(int n) {
        ...
        try {
            ...
            for (int i = 1; i <= n; i++ ) {
                result.addParameter("C" + i, triv, new HashMap<ModuleName, Integer>());
            }

            result.levels = new int[]
                {
                    n
                };
            ...
            for (int i = 1; i <= n; i++ ) {
                Operation proj = new Operation(i + "*_", new Sort[]
                    {
                        tuple
                    }, args[i - 1], modName);
            ...
            for (int i = 1; i <= n; i++ ) {
                Variable var = new Variable("e" + i, args[i - 1]);
            ...
            for (int i = 1; i <= n; i++ ) {
                Term left = new Term(oplist.get(i - 1), share);
    ...
    public static Module createFloat() {
        ...
        try {
            ...
            Sort inte = result.sorts.elementAt(3);
