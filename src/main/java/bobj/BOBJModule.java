...
public class BOBJModule {
    ...
    public static Operation getSetsortOperation() {
        try {
            Sort[] args =
                {
                    BoolModule.univSort, BoolModule.univSort
                };
            Sort res = BoolModule.univSort;
            Operation op = new Operation("~setsort~", args, res, getModuleName());
    ...
    public static Operation getSortOperation() {
        try {
            ...
            Operation op = new Operation("~sort~", args, res, getModuleName());
            op.info = "system-default";
            return op;
        } catch (Exception e) {
            return null;
